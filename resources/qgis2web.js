...
map.getView().fit([3868661.403109, -539025.950117, 3869872.651301, -538186.536279], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">BUS TERMINAL TO ACCOMMODATION FINDER-SINGIDA MUNICIPALITY</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (207 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Welcome to Singida Municipality bus terminal to accommodation finder. A program that will help any new visitor looking for accommodation near the Misuna Bus Terminal. <br />  <br />Designed by Kajiru,Geofrey Julius. <br />';
            }
